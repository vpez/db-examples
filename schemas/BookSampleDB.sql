...
--
-- Host: dbs.aua.am    Database: BookSampleDB
-- ------------------------------------------------------
...
--
-- Current Database: `BookSampleDB`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `BookSampleDB` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
INSERT INTO `classroom` VALUES ('1','144',60),('Packard','101',500),('Painter','514',10),('Taylor','3128',70),('Watson','100',30),('Watson','120',50);
...
CREATE TABLE `course` (
  ...
  KEY `fk_course_dept_idx` (`dept_name`),
  CONSTRAINT `fk_course_dept` FOREIGN KEY (`dept_name`) REFERENCES `department` (`dept_name`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `section` VALUES ('BIO-101','1','Summer',2009,'Painter','514','B'),('BIO-301','1','Summer',2010,'Painter','514','A'),('CS-101','1','Fall',2009,'Packard','101','H'),('CS-101','1','Spring',2009,'Packard','101','F'),('CS-101','1','Spring',2010,'Packard','101','F'),('CS-101','1','Winter',2009,'Watson','120','A'),('CS-190','1','Spring',2009,'Taylor','3128','E'),('CS-190','2','Spring',2009,'Taylor','3128','A'),('CS-315','1','Spring',2010,'Watson','120','D'),('CS-319','1','Spring',2010,'Watson','100','B'),('CS-319','2','Spring',2010,'Taylor','3128','C'),('CS-347','1','Fall',2009,'Taylor','3128','A'),('EE-181','1','Fall',2008,'Taylor','3128','B'),('EE-181','1','Spring',2009,'Taylor','3128','C'),('FIN-201','1','Spring',2010,'Packard','101','B'),('HIS-351','1','Spring',2010,'Painter','514','C'),('MU-199','1','Spring',2010,'Packard','101','D'),('PHY-101','1','Fall',2009,'Watson','100','A');
...
-- Dump completed on 2017-12-25  0:09:17
